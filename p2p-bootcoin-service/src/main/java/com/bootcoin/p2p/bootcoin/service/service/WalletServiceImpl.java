...
public class WalletServiceImpl implements WalletService {
    ...
    @Override
    public Mono<WalletUserResponse> getWallet(Mono<WalletRequest> walletRequest) {
        return walletRequest
                ...
                .flatMap(rq -> {
                    ...
                    log.info("Response from getting wallet: {}");

                    //String user = kafkaProducer.sendAndReceiveWalletInformation(JsonTransferUtil.objectToJson(rq));
                    WalletUserResponse walletUserResponse = new WalletUserResponse();
                    return Mono.just(walletUserResponse);
